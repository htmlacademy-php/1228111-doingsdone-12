...
INSERT tasks (title, status, file, deadline, category_id, user_id) VALUES('Заказать пиццу', '0', '', '2021-02-27', '3', '1');
INSERT tasks (title, status, file, deadline, category_id, user_id) VALUES('Помыть посуду', '1', '', '2021-02-27', '4', '1');
