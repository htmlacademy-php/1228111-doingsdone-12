...
INSERT categories (title, user_id) VALUES('Авто', '2');

INSERT tasks (title, put_date, status, file, deadline, category_id, user_id) VALUES('Покормить кота', '2021-02-26', '1', '', '2021-02-27', '1', '1');
INSERT tasks (title, put_date, status, file, deadline, category_id, user_id) VALUES('Сделать работу', '2021-01-27', '1', '', '2021-02-27', '2', '2');
INSERT tasks (title, put_date, status, file, deadline, category_id, user_id) VALUES('Заказать пиццу', '2021-02-20', '0', '', '2021-02-27', '3', '1');
INSERT tasks (title, put_date, status, file, deadline, category_id, user_id) VALUES('Помыть посуду', '2021-01-01', '1', '', '2021-02-27', '4',);
